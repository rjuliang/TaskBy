...
/**
 * Created by Julian Ramirez on 3/22/2018.
 */
...
public class viewTask extends AppCompatActivity {
    ...
    private void deleteTaskinComplete()
    {
    ...
    private void markCompleted() {
        ...
        fullTask = taskNameEditText.getText().toString() + "      " + fullDate + "       at "
            ...
            databaseConnector.completeTask(rowID,
                    fullTask,
   ...
   //details TEXT, address TEXT, fulldate CHAR, month CHAR, day CHAR
    ...
    public void Clicked(View view)
    {
        ...
        String fullDate = monthLetter+ " " + day;
        String fullShare = "Hi! Don't forget this task: " + taskNameEditText.getText().toString() +
                " on " + fullDate + " at " + hourEditText.getText().toString() + ":" + minutesEditText.getText().toString() +
                " with location at " + taskAddressEditText.getText().toString()+ " Thank you!"+
                " TaskBy® is a free task service. Copyright reserved © 2018 TaskBy.";
